...
prazos_etapas = {
    "Amil":{"prazo": "Dia 15"},
    "Bradesco":{"prazo": "Dia 16"},
    "Seguros Unimed":{"prazo": "Dia 15"},
    "Bradesco (Manual)":{"prazo": "Dia 11"},
    "SulAmérica":{"prazo": "Dia 28"},
    "Unimed Nacional":{"prazo": "Dia 21"},
    "Porto Seguro":{"prazo": "Dia 28"},
    "Omint":{"prazo": "Dia 28"},
    "Omint (manual)":{"prazo": "Dia 21"},
    "Hapvida":{"prazo": "Dia 29"},
...
def carregar_df():
    return gerar_relatorio_pastas(caminhos_4) if LOCAL_ENV else pd.read_csv("dash-dados/csv/anexar_quiver.csv")
