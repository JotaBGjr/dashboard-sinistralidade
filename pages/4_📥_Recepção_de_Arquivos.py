...
def carregar_df():
    return gerar_relatorio_pastas(caminhos_1) if LOCAL_ENV else pd.read_csv("dashboard/csv/anexar_quiver.csv")
...
for etapa in etapas_unicos:
    ...
    ultima_atualizacao = max([ultima_data_arquivo(pasta) for pasta in caminhos_1_pasta if pasta], default="N/A")
