...
def carregar_df():
    return gerar_relatorio_pastas(caminhos_3) if LOCAL_ENV else pd.read_csv("dashboard/csv/envio_relatorios.csv")
...
for etapa in etapas_unicos:
    ...
    ultima_atualizacao = max([ultima_data_arquivo(pasta) for pasta in caminhos_3_pasta if pasta], default="N/A")
